...
public class FormSistema extends javax.swing.JFrame {
    // Declarar estruturas
    Pilha <Recorde>pilha1 = new Pilha(10);
    Pilha <Recorde>desempilha1 = new Pilha(10);
    public FormSistema() {
        initComponents();
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {                                       
        ...
        if(pilha1.isEmpty() || pilha1.peek().getTempo() > novoRecorde.getTempo())
        {
            pilha1.push(novoRecorde);
            listPilha.setText(pilha1.toString());
        } else
        {
            JOptionPane.showMessageDialog(null, "Você inseriu um recorde que não é maior do que o melhor.", "Aviso", JOptionPane.WARNING_MESSAGE);
        }
        txtNome.setText("");
        txtData.setText("");
        txtTempo.setText("");
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        recorde = pilha1.pop();
        desempilha1.push(recorde);
        listAux.setText(desempilha1.toString());
        listPilha.setText(pilha1.toString());
